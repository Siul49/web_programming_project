...
function updateModalText() {
    ...
    const next_btn_text = document.querySelector(".next-button");

    if (step == 0) {
        text.textContent = "허헝~";
        last_btn.style.display = "none";
        next_btn_text.textContent = "다음으로";
    }
    else if (step === 1) {
        ...
        next_btn_text.textContent = "끝내기";
    } else {
        closeModal();  // 마지막 단계 후 모달을 닫음
    }
}
